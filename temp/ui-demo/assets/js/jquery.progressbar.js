	...
	$.extend({
		progressBar: new function() {
			this.defaults = {
				...
				stepDuration	: 40,			// setInterval的时间参数，单位ms
				max				: 100,			// 最大值
				showText		: true,			// 在进度条旁边用百分数或者分数显示进度与否，默认为true
				textFormat		: 'percentage',	// ShowText的显示形式，“percentage”表示百分数，“fraction”表示分数
				width			: 340,			// 进度条图片的宽度，一般不用改的，除非你不用插件自带的图片，那时您需要计算自己的图的宽度
				height			: 12,			// 进度条图片的高度，一般不用改的，除非你不用插件自带的图片，那时您需要计算自己的图的高度
				callback		: null,			// 回调函数，当进度达到目标值的时候触发的函数，默认没有
				boxImage		: '../assets/images/progress_bg.gif',// boxImage : 包着进度条的图片
				barImage		: {
									0:'../assets/images/bg_schedule_68010.png',
									30: '../assets/images/bg_schedule_68010.png',
									50: '../assets/images/bg_schedule_68010.png',
									70: '../assets/images/bg_schedule_68010.png',
									90: '../assets/images/bg_schedule_68010.png'
