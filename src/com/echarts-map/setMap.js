!function () {
        ...
        getData:function () {
            ...
            /*$.ajax({
                ...
                success:function (data) {*/
                    var data = [
                        {time:3, args:[{from:'北京',to:'拉萨'}]}
                        ,{time:4, args:[{from:'上海', to:'西安'},{from:'上海', to:'哈尔滨'}]}
                        ,{time:5, args:[{from:'广州',to:'南宁'},{from:'广州', to:'成都'},{from:'广州', to:'兰州'}]}
                    ];
                    if(data.length<=0){
                        return false;
                    }
                    ...
                    function setData(){
                        ...
                        //console.log("duration time: "+time+"ms");
               ...
               /*}
                error:function(e){
                    console.log(e);
                    clearTimeout(me.getDataInterval);
                }
            });*/
        },
    ...
    function mapDate(){
        ...
        var month = date.getDay().lenght = 1 ? 0+""+date.getDay() : date.getDay();
